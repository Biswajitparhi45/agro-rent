...
import { a as require_react, i as require_jsx_runtime, n as motion$1, r as m$1, t as es_exports } from "../_libs/framer-motion.mjs";
import { n as clsx, t as cva } from "../_libs/class-variance-authority+clsx.mjs";
import { t as twMerge } from "../_libs/tailwind-merge.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/button-C1X1bU2g.js
...
__reExport(react_exports, es_exports);
var motion = motion$1;
var m = m$1;
/**
...
var buttonVariants = cva("inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold cursor-pointer transition-[background,color,box-shadow,transform] duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/40 disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0", {
	variants: {
		variant: {
			default: "bg-primary text-primary-foreground shadow-soft hover:bg-primary/90",
			destructive: "bg-destructive text-destructive-foreground shadow-sm hover:bg-destructive/90",
			outline: "border border-border bg-card/70 shadow-soft hover:bg-accent hover:text-accent-foreground",
			secondary: "bg-secondary text-secondary-foreground shadow-sm hover:bg-secondary/80",
			ghost: "hover:bg-accent hover:text-accent-foreground",
			link: "text-primary underline-offset-4 hover:underline",
			hero: "gradient-primary text-primary-foreground shadow-glow hover:-translate-y-0.5 hover:shadow-float",
			soft: "bg-accent text-accent-foreground hover:bg-primary-soft hover:-translate-y-0.5 hover:shadow-soft",
			glass: "glass text-foreground shadow-soft hover:-translate-y-0.5 hover:shadow-float"
		},
		size: {
...
//#endregion
export { cn as a, motion as c, Tractor as i, react_exports as l, ShieldCheck as n, createLucideIcon as o, Sprout as r, createSlot as s, Button as t, useComposedRefs as u };
