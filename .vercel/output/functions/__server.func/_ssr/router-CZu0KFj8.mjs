...
import { H as useStore, V as useRouter, f as escapeHtml, u as deepEqual, z as useHydrated } from "../__23tanstack-start-server-fn-resolver-6Jz8hF_Q.mjs";
import { n as Link, t as AuthProvider } from "./context-DsbXeIon.mjs";
import { t as Toaster } from "../_libs/sonner.mjs";
import { n as createRootRouteWithContext, r as lazyRouteComponent, t as createFileRoute } from "./lazyRouteComponent-B8dfhZ3u.mjs";
import { t as Route$8 } from "./auth-De6aGf8v.mjs";
import { t as Route$9 } from "./booking-D78M_hih.mjs";
import { t as Route$10 } from "./equipment._id-DiQa_F3b.mjs";
import { t as Route$11 } from "./equipment.index-MViMN9al.mjs";
import { a as RouterCore, d as createNonReactiveMutableStore, f as createNonReactiveReadonlyStore, h as getScriptPreloadAttrs, i as Outlet, m as getAssetCrossOrigin, s as appendUniqueUserTags, v as resolveManifestCssLink } from "./Match-B484qOO0.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-CZu0KFj8.js
...
var Toaster$1 = ({ ...props }) => {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toaster, {
		...
		toastOptions: { classNames: {
			...
			icon: "!mt-0.5",
			error: ["!bg-[oklch(0.18_0.02_155)]", "!border-l-4 !border-l-red-500 !border-y-white/8 !border-r-white/8"].join(" "),
			success: ["!bg-[oklch(0.18_0.02_155)]", "!border-l-4 !border-l-emerald-500 !border-y-white/8 !border-r-white/8"].join(" "),
			info: ["!bg-[oklch(0.18_0.02_155)]", "!border-l-4 !border-l-sky-400 !border-y-white/8 !border-r-white/8"].join(" "),
			warning: ["!bg-[oklch(0.18_0.02_155)]", "!border-l-4 !border-l-amber-400 !border-y-white/8 !border-r-white/8"].join(" "),
			actionButton: [
...
var styles_default = "/assets/styles-C9N4lB06.css";
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
					className: "font-display text-7xl font-extrabold text-foreground",
					children: "404"
				}),
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
						to: "/",
						className: "gradient-primary press inline-flex items-center justify-center rounded-xl px-5 py-2.5 text-sm font-semibold text-primary-foreground shadow-glow",
						children: "Go home"
					})
				})
			]
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						...
						href: "/",
						className: "inline-flex items-center justify-center rounded-xl border border-border bg-card px-5 py-2.5 text-sm font-semibold text-foreground transition-colors hover:bg-accent",
						children: "Go home"
					})]
				})
			]
...
var Route$7 = createRootRouteWithContext()({
	head: () => ({
		meta: [
			...
			{ title: "AgriRent — Rent Agricultural Equipment" },
			{
				name: "description",
				content: "Rent tractors, harvesters, seeders and farming tools from trusted owners near you."
			},
			{
				property: "og:type",
				content: "website"
...
var $$splitComponentImporter$6 = () => import("./routes-k6KXeWG8.mjs");
var Route$6 = createFileRoute("/")({
	head: () => ({ meta: [
		{ title: "AgriRent — Rent Agricultural Equipment Easily" },
		{
			name: "description",
			content: "Rent tractors, harvesters, rotavators, seeders and farming tools from trusted owners near you. Transparent daily pricing and insured bookings."
		},
		{
			property: "og:title",
			content: "AgriRent — Rent Agricultural Equipment Easily"
		},
		{
...
var $$splitComponentImporter$5 = () => import("./about-2agx4cET.mjs");
var Route$5 = createFileRoute("/about")({
	head: () => ({ meta: [
		...
		{
			property: "og:title",
			content: "About AgriRent — Equipment Sharing for Farms"
		},
		{
			property: "og:description",
...
var $$splitComponentImporter$4 = () => import("./admin-Ba6NpBH_.mjs");
var Route$4 = createFileRoute("/admin")({
	head: () => ({ meta: [{ title: "Admin Portal — AgriRent RBAC Management" }, {
		name: "description",
		content: "Platform governance, user management, and equipment verification."
	}] }),
	component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
var $$splitComponentImporter$3 = () => import("./categories-BXC6bvJe.mjs");
var Route$3 = createFileRoute("/categories")({
	head: () => ({ meta: [
		...
		{
			property: "og:title",
			content: "Equipment Categories | AgriRent"
		},
		{
			property: "og:description",
...
var $$splitComponentImporter$2 = () => import("./contact-C6gFE6hw.mjs");
var Route$2 = createFileRoute("/contact")({
	head: () => ({ meta: [
		...
		{
			property: "og:title",
			content: "Contact AgriRent Support"
		},
		{
			property: "og:description",
			content: "Support in seven languages, seven days a week."
		}
	] }),
	component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
var $$splitComponentImporter$1 = () => import("./dashboard-DeRWeCMu.mjs");
var Route$1 = createFileRoute("/dashboard")({
	head: () => ({ meta: [{ title: "Owner Dashboard | AgriRent" }, {
		name: "description",
		content: "Track revenue, manage listings and approve booking requests."
	}] }),
	component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
var $$splitComponentImporter = () => import("./profile-DSSQUxvX.mjs");
var Route = createFileRoute("/profile")({
	head: () => ({ meta: [
		...
		{
			property: "og:title",
			content: "Farmer Portal — My Bookings | AgriRent"
		},
		{
			property: "og:description",
			content: "Complete rental history and active booking tracking."
		}
	] }),
...
var BookingRoute = Route$9.update({
	id: "/booking",
	path: "/booking",
	getParentRoute: () => Route$7
});
var CategoriesRoute = Route$3.update({
	id: "/categories",
	path: "/categories",
	getParentRoute: () => Route$7
});
...
var ProfileRoute = Route.update({
	id: "/profile",
	path: "/profile",
	getParentRoute: () => Route$7
});
var EquipmentIndexRoute = Route$11.update({
	id: "/equipment/",
	path: "/equipment/",
	getParentRoute: () => Route$7
});
var rootRouteChildren = {
	...
	DashboardRoute,
	ProfileRoute,
	EquipmentIdRoute: Route$10.update({
		id: "/equipment/$id",
		path: "/equipment/$id",
		getParentRoute: () => Route$7
	}),
