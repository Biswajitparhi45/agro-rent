import { C as __toESM, c as createServerFn, i as TSS_SERVER_FUNCTION } from "./createServerFn-BH-xKMvN.mjs";
import { a as require_react, i as require_jsx_runtime } from "../_libs/framer-motion.mjs";
import { B as useIntersectionObserver, H as useStore, R as useForwardedRef, S as isDangerousProtocol, V as useRouter, _ as functionalUpdate, j as removeTrailingSlash, p as exactPathTest, u as deepEqual, v as getServerFnById, y as hasKeys, z as useHydrated } from "../__23tanstack-start-server-fn-resolver-6Jz8hF_Q.mjs";
import { n as require_react_dom } from "../_libs/react-dom.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/context-DsbXeIon.js
...
var registerServerFn = createServerFn({ method: "POST" }).validator((data) => data).handler(createSsrRpc("fcf3628aef6eb4608f66fe9e0a23ed16e6d62b5d2100122ae11faa924def22aa"));
var loginServerFn = createServerFn({ method: "POST" }).validator((data) => data).handler(createSsrRpc("6a71e99579dfd6586d8208aea09fd1f903f73c7d5cebe95d24505c22a0b33faa"));
var logoutServerFn = createServerFn({ method: "POST" }).handler(createSsrRpc("8fee1fb5589c8b12ecdf2a77a202bb4988203b3389d3d5251adf7e61fed4dbcd"));
var getCurrentUserServerFn = createServerFn({ method: "GET" }).handler(createSsrRpc("da2ebad19ad65fb12cbcf3a0cccff8b1a08a319bba88dc7d0daf47b589beb282"));
var STORAGE_KEY = "agrirent_user_session";
...
function AuthProvider({ children }) {
	const [user, setUserState] = (0, import_react.useState)(() => {
	...
	const setUser = (u) => {
		setUserState(u);
		if (typeof window !== "undefined") if (u) localStorage.setItem(STORAGE_KEY, JSON.stringify(u));
...
//#endregion
export { useAuth as a, registerServerFn as i, Link as n, useNavigate as o, loginServerFn as r, AuthProvider as t };
